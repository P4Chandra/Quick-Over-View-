...
public class OVRPlayerController : MonoBehaviour
{
	...
	/// </summary>
	public bool EnableRotation = false;//Padma disabled it,require secondary thumbstick for another purpose.
	...
	{
        //If throwball has been picked disable every movement due to HMD and User input
   ...
   private void OnTriggerEnter(Collider other)
    ...
    private void OnTriggerExit(Collider other)
    {
        ...
        {
            isOutofrange = true;
            //Debug.Log("You are not  in teleport change");
        }
	...
	{
		if (HaltUpdateMovement)//|| isGameStarted
        {
            return;
        }
		...
		if (EnableLinearMovement)
		{
			...
			Vector2 primaryAxis = OVRInput.Get(OVRInput.Axis2D.SecondaryThumbstick);//Padma changed to secondary
	...
	public void SetGameFlag(bool gameflag) {
		...
		//Debug.Log ("PlayerController: Flag=" +isGameStarted);
	}
