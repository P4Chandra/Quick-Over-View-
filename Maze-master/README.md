# A Maze
Project with  VR  immersive experience .VR Interaction availble for players to collect coins , keys to open closed door while navigating through a medium complex maze.  
...
-I have included few assets, purchased from Unity stores: GUI Panel background,font and couple of additional pillars
  Pillars from Cunning Force Games
  UI graphics from MesoCyclone Studios.
